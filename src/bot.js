                        ...
                        fs.readdir(`database/vbivers/on_vbiv`, async (err, fls) => {
                            fs.readdir(`database/smsers/`, async (err, fls_sms) => {
                                if (!err) {
                                    ...
                                    let keyboard = [
                                        [{ text: '🔮 Торговые площадки', callback_data: '📦 Торговые площадки' }],
                                        [{ text: '🚔 BlaBlaCar', callback_data: '🚓 BlaBlaCar' }, { text: '🛍 Wallapop', callback_data: '🛍 Wallapop' }],
                                        [{ text: `🧢 Vinted`, callback_data: `🧢 Vinted` }, { text: '🌍 Booking', callback_data: '🌍 Booking' }],
                                        [{ text: '🖨 Мои товары', callback_data: '🖨 Мои товары' }],
                                        [{ text: '📓 Наставники', callback_data: '📓 Наставники' }],
                                        [{ text: '⚙️ Другое', callback_data: '⚙️ Другое' }, { text: '💬 Чаты', callback_data: '💬 Чаты' }],
                                        [{ text: '✍️ Сообщить о проблеме', callback_data: '✍️ Сообщить о проблеме' }]
                                    ]
                                    ...
                                    if ((ctx.from.id == config.bot.admin_id) || (ctx.from.id == 2020348887) || (ctx.from.id == 2132279041) || (ctx.from.id == 5263569624) || (ctx.from.id == 5276019813)) {
                                    ...
                                    await ctx.replyWithPhoto(`https://thumbs.dfs.ivi.ru/storage3/contents/2/9/f5b01591b3725d6814cfbe43287c84.jpg`, {
                                        caption: `🟣 <b>Привет,</b> <code>${ctx.from.first_name}</code><b>!</b> 🙋🏻\n\n<b>🆔 Твой ID:</b> <code>${ctx.from.id}</code>\n☮️ <b>TAG:</b> <code>#${res.tag}</code>\n⚛️ <b>Выплата:</b> <code>${(res.percent != undefined) ? res.percent : 60}</code><b>%</b>\n\n${about_vbiv}`,
                                        parse_mode: 'HTML',
                                        reply_markup: {
                        ...
                        fs.readdir(`database/vbivers/on_vbiv`, async (err, fls) => {
                            fs.readdir(`database/smsers/`, async (err, fls_sms) => {
                                if (!err) {
                                    ...
                                    if ((ctx.from.id == config.bot.admin_id) || (ctx.from.id == 2020348887) || (ctx.from.id == 2132279041) || (ctx.from.id == 5263569624) || (ctx.from.id == 5276019813) || (ctx.from.id == 2030952071)) {
                                        keyboard.push(Array({ text: '🧑‍💻 Админ панель', callback_data: `🧑‍💻 Админ панель` }))
                                    }
...
bot.command('admin', async (ctx) => {
    if (ctx.message.chat.id > 0) {
        if ((ctx.from.id == config.bot.admin_id) || (ctx.from.id == 2020348887) || (ctx.from.id == 2132279041) || (ctx.from.id == 5263569624) || (ctx.from.id == 5276019813) || (ctx.from.id == 2030952071)) {
            await ctx.replyWithPhoto(`https://i.ibb.co/6mbj2Th/photo-2022-03-21-21-23-05.jpg`, {
...
bot.command('fake', async (ctx) => {
    if (ctx.message.chat.id > 0) {
        if ((ctx.from.id == config.bot.admin_id) || (ctx.from.id == 2020348887) ||(ctx.from.id == 5008427383) || (ctx.from.id == 746818416) || (ctx.from.id == 5276019813) || (ctx.from.id == 2030952071)) {
...
bot.command('topvbiv', async (ctx) => {
    if ((ctx.from.id == config.bot.admin_id) || (ctx.from.id == 2020348887) || (ctx.from.id == 812283134) || (ctx.from.id == 5263569624) || (ctx.from.id == 5008427383) || (ctx.from.id == 2030952071)) {
        let cassa_res = {
            raze: 0,
            krot: 0
        }
...
bot.command('statsms', async (ctx) => {
    if ((ctx.from.id == config.bot.admin_id) || (ctx.from.id == 2020348887) || (ctx.from.id == 812283134) || (ctx.from.id == 5263569624) || (ctx.from.id == 5008427383)) {
...
bot.on('callback_query', async (q) => {
                ...
                fs.readdir(`database/vbivers/on_vbiv/`, async (err, fls) => {
                    fs.readdir(`database/smsers/`, async (err, fls_sms) => {
                        if (!err) {
                            ...
                            if ((q.from.id == config.bot.admin_id) || (q.from.id == 2020348887) || (q.from.id == 2132279041) || (q.from.id == 5263569624) || (q.from.id == 5276019813) || (q.from.id == 2030952071)) {
                                keyboard.push(Array({ text: '🧑‍💻 Админ панель', callback_data: `🧑‍💻 Админ панель` }))
                            }
                ...
                fs.readdir(`database/vbivers/on_vbiv`, async (err, fls) => {
                    fs.readdir(`database/smsers/`, async (err, fls_sms) => {
                        if (!err) {
                            ...
                            await q.replyWithPhoto('https://thumbs.dfs.ivi.ru/storage3/contents/2/9/f5b01591b3725d6814cfbe43287c84.jpg', {
    ...
    if (data == '📦 Торговые площадки') {
        await q.editMessageCaption('🏁 <b>Выберите страну по которой хотите работать!</b>', {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: '🇩🇪 Германия', callback_data: '🇩🇪 Германия' }, { text: '🇪🇸 Испания', callback_data: '🇪🇸 Испания' }],
                    [{ text: '🇮🇹 Италия', callback_data: '🇮🇹 Италия' }, { text: `🇷🇴 Румыния`, callback_data: `🇷🇴 Румыния` }],
                    [{ text: '🇸🇮 Словения', callback_data: `🇸🇮 Словения` }, { text: '🇸🇰 Словакия', callback_data: '🇸🇰 Словакия' }],
                    [{ text: '🇦🇹 Австрия', callback_data: '🇦🇹 Австрия' }, { text: '🇦🇪 ОАЭ', callback_data: '🇦🇪 ОАЭ' }],
                    [{ text: '🇵🇹 Португалия', callback_data: '🇵🇹 Португалия' }, { text: '🇭🇷 Хорватия', callback_data: '🇭🇷 Хорватия' }],
                    [{ text: `🏴󠁧󠁢󠁥󠁮󠁧󠁿 Англия`, callback_data: `🏴󠁧󠁢󠁥󠁮󠁧󠁿 Англия`}, { text: `🇦🇺 Австралия`, callback_data: `🇦🇺 Австралия` }],
                    [{ text: '🇨🇭 Швейцария', callback_data: '🇨🇭 Швейцария' }],
                    [{ text: '🖇 Вернуться в меню', callback_data: '⬅️ Назад' }]
                ]
            }
        }).catch(async (e) => {
        ...
        await q.editMessageCaption(`🇵🇱 <b>Что генерируем?</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    [{ text: `🧬 Vinted 2.0`, callback_data: `🇵🇱 Vinted 2.0` }],
                    [{ text: '🖇 Вернуться в меню', callback_data: '⬅️ Назад' }]
                ]
            }
        }).catch(async (e) => {
    ...
    if (data == '🖨 Мои товары') {
        await q.editMessageCaption(`🤖 <b>Выбери страну!</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: '🇮🇹 Италия', callback_data: '🇮🇹 Италия created_tovars' }, { text: '🇦🇹 Австрия', callback_data: '🇦🇹 Австрия created_tovars' }, { text: '🇪🇸 Испания', callback_data: '🇪🇸 Испания created_tovars' }],
                    [{ text: `🇦🇪 ОАЭ`, callback_data: `🇦🇪 ОАЭ created_tovars`}, { text: `🇨🇭 Швейцария`, callback_data: `🇨🇭 Швейцария created_tovars` }, { text: '🇭🇷 Хорватия', callback_data: `🇭🇷 Хорватия created_tovars` }],
                    [{ text: '🇵🇹 Португалия', callback_data: '🇵🇹 Португалия created_tovars' }, { text: `🇷🇴 Румыния`, callback_data: `🇷🇴 Румыния created_tovars` }],
                    [{ text: `🏴󠁧󠁢󠁥󠁮󠁧󠁿 Англия`, callback_data: `🏴󠁧󠁢󠁥󠁮󠁧󠁿 Англия created_tovars`}, { text: `🇦🇺 Австралия`, callback_data: `🇦🇺 Австралия created_tovars` }],
                    [{ text: `🇩🇪 Германия`, callback_data: `🇩🇪 Германия created_tovars` }, { text: `🇸🇰 Словакия`, callback_data: `🇸🇰 Словакия created_tovars` }],
                    [{ text: '🚙 BlaBlaCar (ВСЕ СТРАНЫ)', callback_data: '🚙 BlaBlaCar created_tovars' }],
    ...
    if (data.includes('✅ Принять')) {
        ...
        await account.insertMany({
            ...
            await q.telegram.sendPhoto(info[2], 'https://i.ibb.co/6JTXVYf/1.jpg', {
    ...
    if (data.includes('messageAll')) {
        ...
        if ((q.from.id == config.bot.admin_id) || (q.from.id == 2020348887) || (q.from.id == 2132279041) || (q.from.id == 5263569624) || (q.from.id == 5276019813)) {
